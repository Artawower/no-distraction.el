...
(defcustom no-distraction--ts-rules
  (no-distraction-get-rule 'typescript
                           ...
                           ((export_statement "default" @no-distraction-face))
                           ((export_statement) "export" @no-distraction-face)
                           ((extends_clause "extends" @no-distraction-face))
                           ...
                           ((lexical_declaration "let" @no-distraction-face))
                           ((variable_declaration "var" @no-distraction-face))
                           ((as_expression "as" @no-distraction-face))
                           ((binary_expression "instanceof" @no-distraction-face))
                           ((switch_case "case" @no-distraction-face))
                           ((switch_default "default" @no-distraction-face))
